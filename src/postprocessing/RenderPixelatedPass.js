...
class RenderPixelatedPass extends Pass {
	...
	constructor( pixelSize, scene, camera, options = {} ) {
		...
		this._renderResolution = new THREE.Vector2();

		this._normalMaterial = new THREE.MeshNormalMaterial();

		this._beautyRenderTarget = new THREE.WebGLRenderTarget();
		this._beautyRenderTarget.texture.minFilter = THREE.NearestFilter;
		this._beautyRenderTarget.texture.magFilter = THREE.NearestFilter;
		this._beautyRenderTarget.texture.type = THREE.HalfFloatType;
		this._beautyRenderTarget.depthTexture = new THREE.DepthTexture();

		this._normalRenderTarget = new THREE.WebGLRenderTarget();
		this._normalRenderTarget.texture.minFilter = THREE.NearestFilter;
		this._normalRenderTarget.texture.magFilter = THREE.NearestFilter;
		this._normalRenderTarget.texture.type = THREE.HalfFloatType;
